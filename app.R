...
if (!require("PBSmapping")) install.packages("PBSmapping", repos = "http://cran.us.r-project.org")
...
if (!require("newsanchor")) install.packages("newsanchor", repos = "http://cran.us.r-project.org")
...
scores_names <- read_csv("scores_names.csv")
    ...
    tabItem(tabName = "home",
            ...
            fluidRow(column(width = 6,
              box(title = "ESG Exploration", 
                         ...
                         collapsed = TRUE,
                         solidHeader = TRUE,
                         "This dashboard focuses on ESG scores that can be filtered by region, sector and company size. Investors can use this section to understand which are the companies with the best ESG ranking overall and the regions with more companies based on the filters selection. Besides, they can also review ESG scores trends for the same filter choice."),
...
server <- function(input, output) {
  ...
  set_api_key(api_key = "8a847e3f0c0f451ca0c84cc85e181043", 
              path = "~/.Renviron")
